...
public final class Robot {
	...
	public void simulationInit() {
		team3176.robot.subsystems.arm.ctre.sim.PhysicsSim.getInstance().addTalonFX(_talon, 0.5, 6800);
	}
	public void simulationPeriodic() {
		team3176.robot.subsystems.arm.ctre.sim.PhysicsSim.getInstance().run();
	}
