package team3176.robot.subsystems.arm.ctre.sim;

import team3176.robot.subsystems.arm.ctre.sim.PhysicsSim.SimProfile;
...
class TalonSRXSimProfile extends SimProfile {
    ...
    private double random(double d, double e) {
        return 0;
    }
}